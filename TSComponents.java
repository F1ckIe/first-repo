...
public class TSComponents extends JPanel {
    ...
    private static TSComponents instance;
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                for (int i = 0; i < RowCount1; i++) {
                    ...
                    if (aim.equals(columnData1[i])) {
                        ...
                        BookTitleResult components = new BookTitleResult();
                ...
                for (int i = 0; i < RowCount2; i++) {
                    ...
                    if (aim.equals(columnData2[i])) {
                        ...
                        CDTitleResult components = new CDTitleResult();
                        result.setContentPane(components);
                ...
                for (int i = 0; i < RowCount3; i++) {
                    ...
                    if (aim.equals(columnData3[i])) {
                        ...
                        PictureTitleResult components = new PictureTitleResult();
                        result.setContentPane(components);
                ...
                if (flag == 0) {
                    ...
                    JLabel AWtishi = new JLabel("该标题不存在！");
    ...
    public static TSComponents getInstance() {
        if (instance == null) {
            instance = new TSComponents();
        }
        return instance;
    }
}
